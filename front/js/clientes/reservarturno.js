...
// (mismo patrón que empleado_id hardcodeado en el panel peluquero)
const CLIENTE_ID = 1;

const MESES = ["Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre"];
const DIAS_SEMANA = ["Dom", "Lun", "Mar", "Mié", "Jue", "Vie", "Sáb"]; // getDay(): 0=Domingo

// Franjas horarias fijas (no hay endpoint de disponibilidad todavía).
// TODO: si en algún momento el backend expone horarios ocupados por
// empleado/día, filtrar esta lista contra eso antes de mostrarla.
...
const estado = {
    ...
    fechaMostrada: new Date(),   // mes/año que se está viendo en el calendario
    diaSeleccionado: null,       // Date del día elegido
...
function pintarCalendario() {
    ...
    // Lunes = 0 ... Domingo = 6 (la grilla arranca en Lunes según el HTML)
    ...
    // Días del mes anterior (relleno, no clickeables)
...
function construirFechaISO(fecha, hora) {
    // Formato "YYYY-MM-DDTHH:mm" — confirmado que es el que espera el backend
    // (mismo formato que arma el datetime-local del modal de turnos.js admin).
