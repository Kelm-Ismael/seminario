// Helpers compartidos por todas las páginas del panel barbero.
...
export const EMPLEADO_ID = 2;
export const EMPLEADO_NOMBRE = "Barbero/a";
...
---------------------------------------------------------- */
const CLAVE_LOGO = "barbero_logo_negocio";
const CLAVE_FOTO_PERFIL = "barbero_foto_perfil";
